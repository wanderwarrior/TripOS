...
const schema = z.object({
  ...
  tagline: optStr(80),
  showContactStrip: z.boolean().default(true),
  showRegisteredFooter: z.boolean().default(true),
...
export async function saveProposalBrandingAction(input: ProposalBrandingInput) {
  ...
  await upsertAgencySettings({
    ...
    proposalSurfaceColor: data.surfaceColor,
    proposalTintColor: data.tintColor,
    ...
    proposalTagline: data.tagline,
    proposalShowContactStrip: data.showContactStrip,
    proposalShowRegisteredFooter: data.showRegisteredFooter,
